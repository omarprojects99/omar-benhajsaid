...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid   lg:grid-cols-5 md:grid-row-7  lg:gap-8  grid-cols-1 md:grid-cols-5 gap-8 max-w-7xl mx-auto ",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const rightLists = ["ReactJS", "Python", "GraphQL"];
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              <div className="absolute -bottom-5 right-0 flex h-8 w-8 items-center justify-center rounded-full bg-purple-500/20 text-xl">
                ✨
              </div>
              <MagicButton
