  ...
  return (
    <div className="pointer-events-none  w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        ...
        >
          <>
            <div className="absolute left-1/2 top-1/2 h-[11.25rem] w-[11.25rem] rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]" />
            <div className="absolute left-1/2 top-1/2 ml-2 mt-2 h-[8.5rem] w-[8.5rem] rounded-[50%] bg-sky-400/[0.06] shadow-[0_8px_16px_rgb(0_0_0/0.2)]" />
            <div className="absolute left-1/2 top-1/2 ml-4 mt-4 h-[5.5rem] w-[5.5rem] rounded-[50%] bg-cyan-300/[0.05]" />
          </>
        </div>
